...
//=================Question 2================================
    ...
    void TestQ2_boundary_mytestcase2(CuTest *tc) {
...
*/
    ...
    void TestQ3_invalid_3_mytestcase3(CuTest *tc) {
...
//=================Question 4================================ 
    ...
    void TestQ4_M_mytestcase4(CuTest *tc) {

    			int input = 0;
        double actual = Q4(input);
        double expected = 0;
        CuAssertDblEquals(tc, expected, actual,0.0000000);
    }
...
//=================Question 5================================ 
   ...
   /* void TestQ5_mytestcase5(CuTest *tc) {
...
//=================Question 6================================   
    ...
    void TestQ6_zero_mytestcase6(CuTest *tc) {
            int input = -100000;
            int expected[100]={0},actual[100]={0};
            int expectedCount=0;
            int actualCount = Q6(input,actual);
...
//=================Question 7================================  
    ...
    void TestQ7a_2_mytestcase7a(CuTest *tc) {
        int input = 4000000;
        int actual = Q7a(input);
        int expected = 4;
        CuAssertIntEquals(tc, expected, actual);
    ...
    void TestQ7b_2_mytestcase7b(CuTest *tc) {
        int input = 100000000;
        int actual = Q7b(input);
        int expected = 1;
        CuAssertIntEquals(tc, expected, actual);
    ...
    CuSuite* Lab1GetSuite() {
        ...
        //Question 1 only presents one output because of the conditions provided within the instructions, therefore it has no other methods of being tested
        ...
        SUITE_ADD_TEST(suite, TestQ2_boundary_mytestcase2);
        ...
        SUITE_ADD_TEST(suite, TestQ3_invalid_3_mytestcase3);
        ...
        SUITE_ADD_TEST(suite, TestQ4_M_mytestcase4);

        

        SUITE_ADD_TEST(suite, TestQ5);
        //Question 5 only presents one output, has no arguments and therefore has no other method of being tested
        ...
        SUITE_ADD_TEST(suite, TestQ6_zero_mytestcase6);

        

        SUITE_ADD_TEST(suite, TestQ7a_1);
        SUITE_ADD_TEST(suite, TestQ7a_2);
        SUITE_ADD_TEST(suite, TestQ7a_2_mytestcase7a);


        SUITE_ADD_TEST(suite, TestQ7b_1);
        SUITE_ADD_TEST(suite, TestQ7b_2);
        SUITE_ADD_TEST(suite, TestQ7b_2_mytestcase7b);
