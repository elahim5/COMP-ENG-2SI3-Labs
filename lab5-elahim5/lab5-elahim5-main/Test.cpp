...
void testSLLSetIntArraytestcase() {

        int arr[] = {1, 2, 3, 4, 6}; // this list

        SLLSet listObj2 = SLLSet(arr,5);
        string expectedSet = "1, 2, 3, 4, 6";
        int expectedSize = 5;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
void testIsInFalsetestcase() {

    int arr[] = {1, 2, 3, 4, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);
...
void testAdd3testcase() {

    int arr[] = {1, 2, 3, 5, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);
        ...
        string expectedObj2 = "1, 2, 3, 5, 8, 9";
        int expectedObj2Size = 6;
...
void testUnion4testcase() {
        // test union
    int arr[] = {1, 2, 4, 6, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);
...
void testIntersection4testcase() {
...
bool runAllTests(int argc, char const *argv[]) {
    ...
    s.push_back(CUTE(testSLLSetIntArraytestcase));
    s.push_back(CUTE(testDifference1testcase));
    s.push_back(CUTE(testIntersection4testcase));
    s.push_back(CUTE(testRemove3testcase));
    s.push_back(CUTE(testRemove2testcase));
    s.push_back(CUTE(testAdd3testcase));
    s.push_back(CUTE(testIsInFalsetestcase));
    s.push_back(CUTE(testIsInTruetestcase));
    s.push_back(CUTE(testRemove1testcase));
    s.push_back(CUTE(testUnion4testcase));
